"""
Text-to-3D Interpreter Module using a Small Language Model
...
class LLMInterpreter:
    ...
    def __init__(self, model_name="TinyLlama/TinyLlama-1.1B-Chat-v1.0", device=None):
        ...
        logger.info(f"LLMInterpreter using device: {self.device}")
        ...
        logger.info("LLMInterpreter initialized successfully")
